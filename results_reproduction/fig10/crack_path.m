...
data_file2 = sprintf('map0_%d.txt',j);
data_fem0 = readmatrix(data_file2, 'NumHeaderLines', 0);

data_file0 = sprintf('%d.txt',j);
...
% Set the title
title('Transformer Prediction','Interpreter','latex','FontSize',20,'Color','k');
% Save the plot as an image
%set(gcf,'PaperUnits','inches','PaperPosition',[0 0 16 12]);
print('-dpng','-r1200',sprintf('Transformer%d.png',j));
print('-depsc','-r1200',sprintf('Transformer%d.eps',j));
