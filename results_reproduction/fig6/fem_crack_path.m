...
% Set the title
title('FE Prediction','Interpreter','latex','FontSize',20,'Color','k');
% Save the plot as an image
%set(gcf,'PaperUnits','inches','PaperPosition',[0 0 16 12]);
print('-dpng','-r1200',sprintf('plot_fem%d.png',j));
print('-depsc','-r1200',sprintf('plot_fem%d.eps',j));
