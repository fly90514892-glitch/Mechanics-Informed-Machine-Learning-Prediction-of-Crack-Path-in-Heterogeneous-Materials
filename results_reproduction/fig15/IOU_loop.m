...
legend('631 cases','7176 cases', 'Location', 'northeast', 'FontSize', 15);
...
xlabel('Training dataset sizes', 'FontSize', 20);
ylabel('IoU',       'FontSize', 20);
% title('Mean and Minimum IoU vs Snapshot');
legend('Mean IoU', 'Minimum IoU', 'Location', 'northwest');
set(gca,'FontSize',15);
xlim([631 7176]);
xticks([631 7176]);           % or:  set(gca,'XTick',[631 7176])
xticklabels({'631','7176'});  % optional—MATLAB will label them automatically
